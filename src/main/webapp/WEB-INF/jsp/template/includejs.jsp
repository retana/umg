<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <!-- bootstrap-progressbar -->
   	<script src="<spring:url value="/resources/vendors/bootstrap-progressbar/bootstrap-progressbar.min.js"/>"></script>   
    ...
    <script src="<spring:url value="/resources/vendors/jszip/dist/jszip.min.js"/>"></script>
    <script src="<spring:url value="/resources/vendors/pdfmake/build/pdfmake.min.js"/>"></script>
    <script src="<spring:url value="/resources/vendors/pdfmake/build/vfs_fonts.js"/>"></script>
